...
export default function Modal({
  ...
  // FIXME: Drawer is not working with Mapbox
  // if (isMobile) {
  //   return (
  ...
  //         <Drawer.Content
  //           className={cn(
  //             "fixed bottom-0 left-0 right-0 z-50 mt-24 h-full max-h-fit w-full rounded-t-[10px] border-t border-gray-200 bg-white",
  //             className,
  //           )}
  //         >
